<footer id="main-footer">
    <div class="container footer-grid">
        ...
        <div class="footer-brand text-center">
            <img src="<?php echo BASE_URL; ?>assets/img/logo.png" alt="Villa de Sant Logo" class="footer-img-logo">
        </div>
        <!-- Contact Info -->
        <div class="f-links text-center">
            <ul>
            ...
            <div class="footer-social" style="margin-top: 20px; display: flex; justify-content: center; gap: 15px;">
                <a href="https://linktr.ee/hotelvilladesant?utm_source=linktree_profile_share" target="_blank" class="social-icon whatsapp">
                ...
                <a href="https://www.instagram.com/hotelvilladesant?igshid=YmMyMTA2M2Y%3D" target="_blank" class="social-icon instagram">
    ...
    <div class="footer-bottom">
        <p>&copy; 2026 Hotel Boutique Villa de Sant. <a href="<?php echo BASE_URL; ?>?action=login" style="color: transparent; cursor: default;">Admin</a></p>
    </div>
</footer>
