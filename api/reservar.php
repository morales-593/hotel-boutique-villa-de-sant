...
try {
    ...
    $msg .= "━━━━━━━━━━━━━━━━━━━━━━\n";
    $msg .= "📋 *N° Reserva:* #" . str_pad($reservaId, 4, '0', STR_PAD_LEFT) . "\n\n";
    $msg .= "👤 *Huésped:* $nombre\n";
    $msg .= "📧 *Email:* $email\n";
    $msg .= "📱 *Teléfono:* $telefono\n\n";
    $msg .= "🛏️ *Habitación:* $room_label\n";
    $msg .= "📅 *Check-in:*  $fi (12:00 p.m.)\n";
    $msg .= "📅 *Check-out:* $fo (12:00 p.m.)\n";
    $msg .= "🌙 *Noches:* $nights\n";
    $msg .= "👥 *Huéspedes:* $huespedes\n";
    if ($cupon) {
        $msg .= "🏷️ *Cupón:* $cupon (-$descuento%)\n";
    }
    $msg .= "━━━━━━━━━━━━━━━━━━━━━━\n";
    $msg .= "💵 *TOTAL: \$$total USD*\n";
    $msg .= "━━━━━━━━━━━━━━━━━━━━━━\n";
